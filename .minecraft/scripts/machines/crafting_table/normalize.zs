...
recipes.addShaped(<betterwithmods:bamboo_chime:0>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "oak"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "oak"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
recipes.addShaped(<betterwithmods:bamboo_chime:1>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "spruce"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "spruce"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
recipes.addShaped(<betterwithmods:bamboo_chime:2>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "birch"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "birch"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
recipes.addShaped(<betterwithmods:bamboo_chime:3>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "jungle"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "jungle"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
recipes.addShaped(<betterwithmods:bamboo_chime:4>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "acacia"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "acacia"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
recipes.addShaped(<betterwithmods:bamboo_chime:5>, [[null, <ore:string>, null],[<ore:string>, <ore:pressurePlateWood>, <ore:string>], [<ore:bamboo>, <betterwithmods:moulding_wood>.withTag({texture: {Properties: {variant: "dark_oak"}, Name: "minecraft:planks"}}).onlyWithTag({texture: {Properties: {variant: "dark_oak"}, Name: "minecraft:planks"}}), <ore:bamboo>]]);
